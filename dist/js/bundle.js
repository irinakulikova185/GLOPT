...
/* harmony import */ var _modules_togglePriceCards__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./modules/togglePriceCards */ "./src/js/modules/togglePriceCards.js");
...
window.addEventListener('DOMContentLoaded', function () {
  ...
  Object(_modules_togglePriceCards__WEBPACK_IMPORTED_MODULE_5__["default"])();
...
var forms = function forms() {
  ...
  form.forEach(function (item) {
    item.addEventListener('submit', function (e) {
      ...
      var showStatusMessage = function showStatusMessage() {
      ...
      postData('server.php', formData).then(function (res) {
        ...
        loadMessage.remove();
        showStatusMessage();
        document.querySelector('.modal__statusMessage').textContent = '';
        document.querySelector('.modal__statusMessage').textContent = 'Произошла ошибка..Повторите попытку позднее';
      }).finally(function () {
        //   form.reset();
        clearInputs();
      });
...
var gamburger = function gamburger() {
...
var mask = function mask(selector) {
  var setCursorPosition = function setCursorPosition(pos, elem) {
    ...
    if (elem.serSelectionRange) {
      elem.serSelectionRange(pos, pos);
...
var modals = function modals() {
  ...
  bindModal('.button_recall', '#recall', '.modal__close_recall');
  bindModal('.button_calculation', '#recall', '.modal__close_recall');
  bindModal('.button_prices', '#recall', '.modal__close_recall');
...
var scrolling = function scrolling() {
  var upElems = document.querySelectorAll('.pageup'),
      links = document.querySelectorAll('[href^="#"]');
  window.addEventListener('scroll', function () {
    if (document.documentElement.scrollTop > 1650) {
      upElems.forEach(function (upElem) {
  ...
  var calcScroll = function calcScroll(elements) {
...
var slider = function slider() {
  var slides = document.querySelectorAll('.feed-back__item'),
  ...
  function swipeStart(event) {
    var evt = event.type.includes('touch') == true ? event.touches[0] : event;
  ...
  function swipeAction(event) {
    var evt = event.type.includes('touch') == true ? event.touches[0] : event;
    var style = sliderField.style.transform,
        transform = +style.match(trfRegExp)[0];
    posX2 = posX1 - evt.clientX;
    posX1 = evt.clientX;
    sliderField.style.transform = "translateX(".concat(transform - posX2, "px)");
  }
...
/***/ "./src/js/modules/togglePriceCards.js":
/*!********************************************!*\
  !*** ./src/js/modules/togglePriceCards.js ***!
  \********************************************/
/*! exports provided: default */
...
var togglePriceCards = function togglePriceCards() {
  var toggleSlide = function toggleSlide(btnsSelector) {
...
/* harmony default export */ __webpack_exports__["default"] = (togglePriceCards);
