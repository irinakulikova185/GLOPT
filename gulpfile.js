...
//  	.pipe(gulp.dest(dist)) // Выгрузим результат в папку "app/css/"
...
//  	.pipe(gulp.dest(dist)) // Выгружаем оптимизированные изображения в папку назначения
//  }
//  function startwatch() { //следим за изменениями и запускаем соответствующую функцию
//      gulp.watch(['src/**/*.js', '!src/js/bundle.js'], gulp.parallel(buildJs));
//      gulp.watch('src/sass/**/*.+(scss|sass|css)', gulp.parallel(styles));
//      gulp.watch('src/*.html', gulp.parallel(copyHtml));
//      gulp.watch('src/images/origin/*', gulp.parallel(images));
//  }
...
// //  exports.build = gulp.parallel(copyHtml, buildJs, styles);
//  exports.default = gulp.parallel(startwatch, copyHtml, buildJs, styles, browsersync);
